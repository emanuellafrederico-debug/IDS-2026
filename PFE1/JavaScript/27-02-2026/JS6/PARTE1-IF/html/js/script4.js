...
function confereMaiorMenor() {
   ...
   let valor2 = Number(num2.value);
    ...
    if (valor1>valor2){
         document.getElementById("resultado").innerText = "O primeiro valor é maior... " + valor1 + " é maior que " + valor2;
    } else if(valor1<valor2){
         document.getElementById("resultado").innerText = "O segundo valor é maior..." + valor2 + " é maior que " + valor1;
    } else{
